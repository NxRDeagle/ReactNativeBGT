...
import { createComponentComments, getComponentComments } from '../../services/routes';
import userAvatar from "../../img/user_avatar.jpg";

export default function PcComponentComments() {
    ...
    useEffect(() => {
        const loadData = async () => {
            ...
            const foundComments = await getComponentComments(id);
